...
public class ReadingFrame {
    ...
    ReadingFrame(){
        ...
        try {
            ...
            s = ImageIO.read(new File("D:\\qrCodes\\images\\ereader.png"));
        }
        catch (IOException e){
            e.printStackTrace();
        }
        ...
        background = new ImageIcon("D:\\GLA Simulation\\src\\images\\managementbackground.jpg");
