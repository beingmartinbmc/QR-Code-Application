...
public class Menu {
    ...
    Menu(){
        ...
        try{
            a=ImageIO.read(new File("D:\\qrCodes\\images\\pen.png"));
            s=ImageIO.read(new File("D:\\qrCodes\\images\\eye.png"));
            d=ImageIO.read(new File("D:\\qrCodes\\images\\exit.png"));
        }
        catch (IOException e){
            e.printStackTrace();
        }
        ...
        background = new ImageIcon("D:\\GLA Simulation\\src\\images\\homeworkbackground.jpg");
        ...
        JOptionPane.showMessageDialog(frame,"This is a QR code applet created by Ankit Sharma.\nYou can create your own your QR-Code, and can also read them\nAll Images are clickable!");
    }
